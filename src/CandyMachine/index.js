...
const CandyMachine = ({ walletAddress }) => {
	...
	const getCandyMachineState = async () => {
		...
		const candyMachine = await program.account.candyMachine.fetch(
			process.env.REACT_APP_CANDY_MACHINE_ID ? process.env.REACT_APP_CANDY_MACHINE_ID :"3TTyGWzGBvoCepMoQY5Pj5HhtqFwbRacTmPf8qcnfBrj"
		);
	...
	const getProvider = () => {
		...
		const connection = new Connection(rpcHost ? rpcHost : web3.clusterApiUrl('devnet'),);
